...
[![Build Status](https://travis-ci.org/odedshr/html-encoder.svg?branch=gh-pages.src)](https://travis-ci.org/odedshr/html-encoder)
...
A small library + CLI a for converting HTML to javascript code

## Installation:
```
npm i -D html-encoder
```
...
fs.writeFileSync('./node.js', htmlEncoder(originalHMTL))
```
